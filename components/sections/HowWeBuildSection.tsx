      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        <AnimatedSection className="mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-end">
            ...
            <div>
              <p className="text-slate-500 text-base leading-relaxed jp mb-1">
          ...
          {steps.map(step => (
            <StaggerItem key={step.number}>
              <motion.div
                ...
                className="group flex items-center gap-5 lg:gap-8 p-5 rounded-[20px] cursor-default"
                style={{
                  background:  "#ffffff",
              ...
              >
                ...
                <div className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center transition-all duration-200 group-hover:bg-[#1E3A8A]"
