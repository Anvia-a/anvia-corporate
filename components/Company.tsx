...
const coreLetters: Letter[] = [
    { ch: 'A', vars: { '--x0': '-4%', '--y0': '18%', '--xw1': '26%', '--yw1': '16%', '--xw2': '24%', '--yw2': '62%', '--xa': '23.8%', '--ya': '47%', '--xb': '12%', '--yb': '26%', '--xn': '48%', '--yn': '49%', '--delay': '0s', '--dur': '12.5s' } },
    { ch: 'N', vars: { '--x0': '106%', '--y0': '14%', '--xw1': '76%', '--yw1': '34%', '--xw2': '48%', '--yw2': '22%', '--xa': '41.9%', '--ya': '47%', '--xb': '62%', '--yb': '22%', '--xn': '49%', '--yn': '49%', '--delay': '0.05s', '--dur': '12.55s' } },
    { ch: 'E', vars: { '--x0': '-4%', '--y0': '84%', '--xw1': '54%', '--yw1': '74%', '--xw2': '70%', '--yw2': '46%', '--xa': '49.1%', '--ya': '47%', '--xb': '34%', '--yb': '79%', '--xn': '50%', '--yn': '49%', '--delay': '0.1s', '--dur': '12.9s' } },
    { ch: 'W', vars: { '--x0': '98%', '--y0': '80%', '--xw1': '38%', '--yw1': '70%', '--xw2': '26%', '--yw2': '42%', '--xa': '57.2%', '--ya': '47%', '--xb': '86%', '--yb': '71%', '--xn': '51%', '--yn': '49%', '--delay': '0.15s', '--dur': '13.05s' } },
    { ch: 'V', vars: { '--x0': '-6%', '--y0': '56%', '--xw1': '20%', '--yw1': '28%', '--xw2': '64%', '--yw2': '16%', '--xa': '71.2%', '--ya': '47%', '--xb': '20%', '--yb': '60%', '--xn': '52%', '--yn': '49%', '--delay': '0.2s', '--dur': '12.35s' } },
    { ch: 'I', vars: { '--x0': '108%', '--y0': '52%', '--xw1': '72%', '--yw1': '62%', '--xw2': '36%', '--yw2': '76%', '--xa': '77.1%', '--ya': '47%', '--xb': '94%', '--yb': '42%', '--xn': '53%', '--yn': '49%', '--delay': '0.24s', '--dur': '12.7s' } },
    { ch: 'A', vars: { '--x0': '56%', '--y0': '4%', '--xw1': '60%', '--yw1': '18%', '--xw2': '88%', '--yw2': '58%', '--xa': '84.8%', '--ya': '47%', '--xb': '76%', '--yb': '8%', '--xn': '54%', '--yn': '49%', '--delay': '0.29s', '--dur': '13.2s' } },
];
...
const extraLetters: Letter[] = [
    ...
    { ch: 'P', vars: { '--x0': '90%', '--y0': '16%', '--xw1': '94%', '--yw1': '38%', '--xw2': '74%', '--yw2': '48%', '--xa': '71.2%', '--ya': '24%', '--xb': '96%', '--yb': '34%', '--xn': '50%', '--yn': '48%', '--delay': '0.12s', '--dur': '12.95s' } },
    { ch: 'C', vars: { '--x0': '108%', '--y0': '30%', '--xw1': '84%', '--yw1': '54%', '--xw2': '64%', '--yw2': '64%', '--xa': '78%', '--ya': '24%', '--xb': '98%', '--yb': '52%', '--xn': '51%', '--yn': '48%', '--delay': '0.14s', '--dur': '13.05s' } },
    ...
    { ch: 'B', vars: { '--x0': '-4%', '--y0': '72%', '--xw1': '22%', '--yw1': '42%', '--xw2': '40%', '--yw2': '30%', '--xa': '68%', '--ya': '68%', '--xb': '2%', '--yb': '56%', '--xn': '51%', '--yn': '51%', '--delay': '0.26s', '--dur': '13.28s' } },
];
