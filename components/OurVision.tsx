                    ...
                    <AnimateOnScroll>
                        <div className={styles.left}>
                            ...
                            <h2 className="section-heading">
                                <span style={{ display: 'inline-block', whiteSpace: 'nowrap' }}>私たちは、</span><br />
                                <span style={{ display: 'inline-block', whiteSpace: 'nowrap' }}>時間は管理すべきリソースではなく、</span><br />
                                <span style={{ display: 'inline-block', whiteSpace: 'nowrap' }}>人生を形づくる</span><br />
                                <span style={{ display: 'inline-block', whiteSpace: 'nowrap' }}><span className="gradient-text">最も重要な価値</span>だと考えています。</span>
                            </h2>
                        </div>
                    </AnimateOnScroll >
